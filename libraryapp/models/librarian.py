...
#librarian is our user     one to one - one matching row in each table,   we are listening for events and it will do something (one to make, when we make a librarian it's also a user.... so they will be linked)
